...
const StatsSection: React.FC = () => {
  ...
  return (
    <section className="bg-[#f1f4f9] py-16 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-12">
        {stats.map((stat, idx) => (
          <div key={idx} className="flex flex-col items-center text-center">
            ...
            <div className="text-4xl font-black text-[#1a202c] mb-1">
              {stat.value}
            </div>
            <div className="text-[10px] font-bold text-gray-500 tracking-[0.15em] uppercase">
              {stat.label}
            </div>
          </div>
        ))}
